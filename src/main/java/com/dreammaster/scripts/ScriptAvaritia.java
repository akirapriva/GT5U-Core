...
public class ScriptAvaritia implements IScriptLoader {
    ...
    public List<String> getDependencies() {
        return Arrays.asList(Avaritia.ID);
    }
    ...
    public void loadRecipes() {
                ...
                if (USML) {
                    ...
                    if (DEML && EIOML) {
                        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                                ...
                                getModItem(
                                        ...
                                        "universal.draconicEvolution.singularity",
                                        1,
                                        0,
                                        missing),
                                'c',
                    ...
                    if (TCML && EIOML && PREDML) {
                        ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
                                ...
                                getModItem(
                                        UniversalSingularities.ID,
                                        "universal.projectRed.singularity",
                                        1,
                                        0,
                                        missing),
                                'f',
                                ...
                                getModItem(
                                        UniversalSingularities.ID,
                                        "universal.tinkersConstruct.singularity",
                                        1,
                                        1,
                                        missing),
                                'h',
        ...
        if (BAML && DEML && TMML && BML && FMML && TTML && TGML && GSuiteML) {
            ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
        ...
        if (TTML && TMML && FMML && BML && BAML && DEML && GSuiteML) {
            ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
        ...
        if (TTML && GSuiteML && TMML && DEML && BML && WGML) {
            ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
        ...
        if (TMML && TTML && BAML && DEML && BML && EMTML && GSML) {
            if (ASML) {
                ExtremeCraftingManager.getInstance().addExtremeShapedOreRecipe(
